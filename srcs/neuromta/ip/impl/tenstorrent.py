...
if __name__ == "__main__":
    ...
    from neuromta.common.buffer_handle import BufferHandle, CircularBufferHandle, PageHandle
    ...
    ofm_buffer_1 = BufferHandle("ofm_buffer_1", addr=device.mem_context.get_main_mem_addr(2, 0, 0), page_size=32*32*4, n_pages=4)
    ...
    core_group_1 = device.npu_cores[0:4]
    
    for i, core in enumerate(core_group_1):
        single_tile_gemm_os_kernel(
            core, ifm_buffer_1, wgt_buffer_1, ofm_buffer_1,
            M=64, N=64, K=64,
            m_tile=32, n_tile=32, k_tile=32,
            m_tile_idx=i // 2, n_tile_idx=i % 2,
        )
